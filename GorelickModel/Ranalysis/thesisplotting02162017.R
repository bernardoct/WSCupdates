...
plotD = ggplot() +
  ...
  scale_colour_manual(name = element_blank(),
                     labels = c("ROF Guide Curve", 
                                "Storage (Without Releases)", 
                                "Storage (Spot Releases)"),
                     values = c("green"="green", 
                                "blue"="blue", 
                                "black"="black")) +
  theme(legend.position = c(0.05,0.05), legend.box = "horizontal",
...
png(paste(figurepath, "Figure1.3", ".png", sep = ""), units = "in", width = 12, height = 7, res = 300)
...
write.csv(ParallelPlotData1, paste(figurepath, "ParallelPlotDatabyFormulationTwoPlusOptions.csv", sep = ""), row.names = F)
